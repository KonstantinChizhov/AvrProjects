...
//-----------------------------------------------------------------------------
template<int value, class Cases, class DefaultType = NullType> struct StaticSwitch;

template<int value, class Head, class Tail, class DefaultType>
struct StaticSwitch<value, Typelist<Head, Tail>, DefaultType>
{
     typedef typename StaticSwitch<value, Tail, DefaultType>::Result Result;
};

template<int value, class DefaultType>
struct StaticSwitch<value, NullType, DefaultType>
{
    typedef DefaultType Result;
};

template<int value, class CaseResult, class Tail, class DefaultType>
struct StaticSwitch<value, Typelist<Case<value, CaseResult>, Tail>, DefaultType>
{
...
struct StaticSwitchValue<value, Typelist<Head, Tail>, DefaultValue>
{
     enum{Value =  StaticSwitchValue<value, Tail, DefaultValue>::Value};
};

template<int value, int DefaultValue>
struct StaticSwitchValue<value, NullType, DefaultValue>
{
   enum{Value = DefaultValue};
};

template<int value, int ResultValue, class Tail, int DefaultValue>
struct StaticSwitchValue<value, Typelist<CaseValue<value, ResultValue>, Tail>, DefaultValue>
{
